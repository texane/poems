...
\resetcolorseries[24]{verso}
\begin{verso}
\makebox[1em][c]{\lettrine{W}{}}ith high voltage, the electron,
Escapes as ball from the canon.
\end{verso}

\begin{verso}
It is then accelerated,
Until it gains its final speed.
\end{verso}

\begin{verso}
The particles, as they turn right,
Loose energy, emitting light.
\end{verso}

\begin{verso}
In the beamlines, through slots and glass,
